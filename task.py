...
Button(root, width=8, text="Вікно 2", font="Arial 10", command=window2).place(x=5, y=100)
...
Button(root, width=8, text="Вікно 3", font="Arial 10", command=window3).place(x=85, y=100)
...
def window4():
    ...
    RS_uni = functios.objednanya(R, S)
...
Button(root, width=8, text="Вікно 4", font="Arial 10", command=window4).place(x=165, y=100)
root.mainloop()
